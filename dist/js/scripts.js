"use strict";// create_clone_images("https://picsum.photos/250/350", 10);
...
//   });
// }
document.addEventListener("aos:in:super-duper",function(){create_circles();});function create_circles(){var circles=document.querySelectorAll('[data-type="circle"]');setTimeout(circles.forEach(function(circle){var number_of_circles=circle.attributes["data-circle-count"].value;var growth_interval=100/number_of_circles;var current_growth_rate=100;for(var x=1;x<=number_of_circles;x++){var innerCircle=document.createElement("div");innerCircle.classList.add("circle__innerCircle");innerCircle.style.width=current_growth_rate+"%";innerCircle.style.height=current_growth_rate+"%";circle.appendChild(innerCircle);current_growth_rate=current_growth_rate-growth_interval;}}),1000);}